...
df_bckup = df.copy() # copy dataframe for speed comparison below
...
s = [1 if (x == 'Jason' and y == 'USA') else 2 if (x == 'Helen' and y == 'France') else 0 for x,y in zip(df_bckup.first_name, df_bckup.nationality)]
